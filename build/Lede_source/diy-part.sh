...
cat >$NETIP <<-EOF
uci set network.lan.ipaddr='10.20.1.2'                      # IPv4 地址(openwrt后台地址)
uci set network.lan.netmask='255.255.255.0'                   # IPv4 子网掩码
#uci set network.lan.gateway='10.20.1.1'                    # 旁路由设置 IPv4 网关（去掉uci前面的#生效）
...
uci set system.@system[0].hostname='OpenWrt-mama'              # 修改主机名称为OpenWrt-123
